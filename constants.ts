...
export const ENVELOPES: EnvelopeData[] = [
  ...
  { 
    id: 12, 
    title: "Dec", 
    // Fixed: Changed " to ` to allow multi-line string
    message: `大多数时候，我已经不会再想那么多了，毕竟你早就不在恋爱的心流里了🤪（你自己知道） 偶尔会涌上一丢委屈，明明根本不是我的原因😡  但问题不大，往好了想，我这么善良地不为难人，是在积德的呀，肯定会越来越美丽和闪耀吧😌`, 
